...
public class DrawFrame extends JFrame
{
    ...
    private JButton save; // button to clear panel
...
String output = sb.toString();
 ...
 //random name       
        ...
        BufferedImage image = new BufferedImage(220,400, BufferedImage.TYPE_INT_RGB);
        ...
        //outputFile.getParentFile().mkdirs();    
            ...
            ImageIO.write(image, "gif", new File("img/"+output+".gif"));
